...
/*! \page page1 Межпроцессорные коммуникации
    ...
    |    |    | 2. Установить M0M1 в состояние MODE_RECEIVE.                              | 2. Устанавливает D0...D7 (если данных для передачи нет, передаёт 0).            |
    |    |    | 3. Дождаться "1" на READY (панель установила данные).                     | 3. Установить READY в "1".                                                      |
    |    |    | 4. Установить M0M1 в MODE_DISABLE. Это запрещает дальнейший обмен и даёт  | 4. Дождаться появления MODE_DISABLE на M0M1.                                            |
    |    |    |    панели понять, что данные прочитаны.                                   | 5. Установить D0...D7 в состояние in, READY в состояние "1".                    |
    +----+----+---------------------------------------------------------------------------+---------------------------------------------------------------------------------+
