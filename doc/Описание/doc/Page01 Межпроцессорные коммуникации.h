...
/*! \page page1 Межпроцессорные коммуникации
    ...
    |    |       | 127 PG12 NE4 | IO | BYTE_SET       | 7  PC13     | IO | Признак установки выходных данных. Активный уровень - "0".                             |
    |    |       |              |    |                |             |    |                                                                                        |
    |    |       | 119 PD5  NWE | IO | BYTE_CONFIRM   | 86 PD5  NWE | IO | Подтверждение приёма данных. Активный уровень - "1".                                   |
    |    |       |              |    |                |             |    |                                                                                        |
    ...
    \section section2 Обмен данными
        ...
        Разные уровни на MODE_PANEL и MODE_CONFIRM означают, что взаимодействия не происходит. Передача данных из панели в устройство (MODE_PANEL == "0") является 
        приоритетной задачей. Перед тем, как произвести передачу данных в панель, устройство должно принять информацию из панели.
        ...
        \subsection subsec1 Приём/передача на стороне устройства.
            ...
            *** Передача данных устройством ***
            ...
            2. Установить "1" на BYTE_SET.
            3. Перевести пины в режим передачи в панель.
        ...
        \subsection subsec2 Приём/передача на стороне панели.
            ...
            *** Приём данных панелью ***
            ...
            Когда панель готова к приёму инфомации, MODE_PANEL установлен в "1".
            
            1. Прочитать MODE_CONFIRM:
                - "0" - у устройства нет данных для передачи, выход;
                - "1" - у устройства есть данные для передачи.
            2. Переводим пины в режим приёма.
            3. Ожидаем "0" на BYTE_SET.
            4. Считываем данные.
            5. Устанавливаем BYTE_CONFIRM в "1"
