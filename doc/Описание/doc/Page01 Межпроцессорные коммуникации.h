...
/*! \page page1 Межпроцессорные коммуникации
    ...
    |    |       | 118 PD4  RD  | IO | READ_READY     | 85 PD4  RD  | IO | Признак того, что читающее устройство считало данные. Активный уровень - "0".          |
    |    |       | 44  PC4      | IO | CONFIRM_READ   | 9  PC15     | IO | Подтверждение того, что записывающее устройство восприняло сигнал успешного считывания |
    |    |       |              |    |                |             |    | своих данных.
