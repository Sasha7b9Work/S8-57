...
// В старой версии (опытных образцах) добавлена внешняя память и изменена некоторая распиновка. Для компиляции старой версии раскомментируйте следующую строку
//#define OLD_VERSION
