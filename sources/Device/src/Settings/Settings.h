...
#include "Recorder/Types_Recorder.h"
...
public:
    ...
    Cursors::Control::E     curs_cntrlU[Chan::Number];          ///< Активные курсоры напряжения.
    Cursors::Control::E     curs_cntrlT[Chan::Number];          ///< Активные курсоры времени.
...
#define MAX_SYMBOLS_IN_FILE_NAME 35
    ...
    FPGA::Settings::Bandwidth dbg_bandwidth[2];               ///< \brief Здесь задаётся полоса, которая будет включаться при выборе в "КАНАЛ-Полоса" 
                                                        ///< значения "Полная".
