...
/// Ќарисовать значение регул€тора в режиме поразр€дной регулировки
/// setPosFromEnd - подсвеченный (активный) разр€д, начина€ с конца. ≈сли selPosFromEnd == -1, подсвечивать не нужно
...
void GovernorColor::DrawValue(int x, int y)
{
    ...
    const pString texts[4] = {"яр", "—н", "«л", " р"};
