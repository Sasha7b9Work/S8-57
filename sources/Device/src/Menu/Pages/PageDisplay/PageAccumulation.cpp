...
DEF_CHOICE_2( cEnable,                                                                                                                                 //--- ДИСПЛЕЙ - НАКОПЛЕНИЕ - Режим ---
    ...
    DISABLE_RU,
    ENABLE_RU,
    ACCUMULATION, pageAccum, Choice::FuncActive, Choice::FuncChange, Choice::FuncDraw
)
...
DEF_CHOICE_9( cNumber,                                                                                                                            //--- ДИСПЛЕЙ - НАКОПЛЕНИЕ - Количество ---
    ...
    "128",
    "Бесконечность",
    ENUM_ACCUM, pageAccum, Choice::FuncActive, Choice::FuncChange, Choice::FuncDraw
)
...
DEF_PAGE_3(pageAccum, // -V641 // -V1027                                                                                                                       //--- ДИСПЛЕЙ - НАКОПЛЕНИЕ ---
    ...
    Page::Name::Display_Accumulation, PageDisplay::pointer, IsActive_Accum, Page::FuncPress, Page::FuncDraw, FuncRegSetPage
)
