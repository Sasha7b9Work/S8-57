...
DEF_CHOICE_7( cNumber,                                                                                                                             //--- ИЗМЕРЕНИЯ - АВТОМАТ - Количество ---
    ...
    "6x1",
    "6x2",
    NUM_MEASURES, pageAuto, IsActive_NumberChannels, Choice::FuncChange, Choice::FuncDraw
)
...
DEF_CHOICE_3(       cChannels,                                                                                  //--- ИЗМЕРЕНИЯ - АВТОМАТ - Каналы ---
    ...
    "2",
    "1 и 2",
    SOURCE_MEASURES, pageAuto, IsActive_NumberChannels, Choice::FuncChange, Choice::FuncDraw
)
...
DEF_PAGE_4( pageAuto, // -V641 // -V1027                                                                                                                           //--- ИЗМЕРЕНИЯ - АВТО ---
    ...
    Page::Name::Measures_Auto, PageMeasures::pointer, Page::FuncActive, Page::FuncPress, Page::FuncDraw, FuncRegSetPage
)
