...
DEF_SMALL_BUTTON_HINTS_2( bSet_Channel,                                                                                                    //--- ИЗМЕРЕНИЯ - КУРСОРЫ - УСТАНОВИТЬ - Канал ---
    ...
    pageSet, 0, PageMeasures::PageCursors::PageSet::OnPress_Set_Channel, PageMeasures::PageCursors::PageSet::Draw_Set_Channel,
...
DEF_SMALL_BUTTON_HINTS_5( bSet_T,                                                                                                      //--- ИЗМЕРЕНИЯ - КУРСОРЫ - УСТАНОВИТЬ - Курсоры Т ---
    ...
    pageSet, 0, PageMeasures::PageCursors::PageSet::OnPress_Set_T, Draw_Set_T,
...
DEF_SMALL_BUTTON_HINTS_5( bSet_U,                                                                                                      //--- ИЗМЕРЕНИЯ - КУРСОРЫ - УСТАНОВИТЬ - Курсоры U ---
    ...
    pageSet, 0, PageMeasures::PageCursors::PageSet::OnPress_Set_U, Draw_Set_U,
...
DEF_SMALL_BUTTON( bSet_100,                                                                                                                 //--- ИЗМЕРЕНИЯ - КУРСОРЫ - УСТАНОВИТЬ - 100% ---
    ...
    pageSet, 0, OnPress_Set_100, Draw_Set_100
)
...
DEF_SMALL_BUTTON_HINTS_2( bSet_Movement,                                                                                             //--- ИЗМЕРЕНИЯ - КУРСОРЫ - УСТАНОВИТЬ - Перемещение ---
    ...
    pageSet, 0, OnPress_Set_Movement, Draw_Set_Movement,
...
DEF_PAGE_4( pageSet, // -V641 // -V1027                                                                                                            //--- ИЗМЕРЕНИЯ - КУРСОРЫ - УСТАНОВИТЬ ---
    ...
    Page::Name::Measures_Cursors_Set, PageMeasures::PageCursors::pointer, 0, Page::FuncPress, Page::FuncDraw,
