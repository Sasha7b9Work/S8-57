...
DEF_CHOICE_2( cShow,                                                                                                                                           //--- КУРСОРЫ - Показывать ---
    ...
    "Нет",
    "Да",
    CURS_SHOW, pageCursors, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_4( cLookModeChanA,                                                                                                                            //--- КУРСОРЫ - Слежение канал 1 ---
    ...
    "Время",
    "Напряж и время",
    CURS_LOOK_MODE(Chan::A), pageCursors, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_4( cLookModeChanB,                                                                                                                            //--- КУРСОРЫ - Слежение канал 2 ---
    ...
    "Время",
    "Напряж. и время",
    CURS_LOOK_MODE(Chan::B), pageCursors, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_2( cShowFreq,                                                                                                                                             //--- КУРОСРЫ - 1/dT ---
    ...
    DISABLE_RU,
    ENABLE_RU,
    CURSORS_SHOW_FREQ, pageCursors, 0, 0, Choice::FuncDraw
)
