...
DEF_SMALL_BUTTON_HINTS_3(bFunction_Screen,                                                                                                                //--- СЕРВИС - ФУНКЦИЯ - Экран ---
    ...
    pageMath, 0, OnPress_Function_Screen, Draw_Function_Screen,
...
DEF_SMALL_BUTTON_HINTS_2(bFunction_Type,                                                                                                                    //--- СЕРВИС - ФУНКЦИЯ - Вид ---
    ...
    pageMath, 0, OnPress_Function_Type, Draw_Function_Type,
...
DEF_SMALL_BUTTON_HINTS_2(bFunction_ModeRegSet,                                                                                            //--- СЕРВИС - ФУНКЦИЯ - Режим ручки УСТАНОВКА ---
    ...
    pageMath, 0, OnPress_Function_ModeRegSet, Draw_Function_ModeRegSet,
...
DEF_SMALL_BUTTON(bFunction_RangeA,                                                                                                          //--- СЕРВИС - ФУНКЦИЯ - Масштаб 1-го канала ---
    ...
    pageMath, 0, OnPress_Function_RangeA, Draw_Function_RangeA
)
...
DEF_SMALL_BUTTON(bFunction_RangeB,                                                                                                          //--- СЕРВИС - ФУНКЦИЯ - Масштаб 2-го канала ---
    ...
    pageMath, 0, OnPress_Function_RangeB, Draw_Function_RangeB
)
...
DEF_PAGE_5( pageMath, // -V641                                                                                                                                   //--- СЕРВИС - ФУНКЦИЯ ---
    ...
    &bFunction_RangeA,
    &bFunction_RangeB,
    Page::Name::SB_Service_Function, PageMeasures::pointer, IsActive_Function, OnPress_Function, 0, HandlerKey_Function
)
