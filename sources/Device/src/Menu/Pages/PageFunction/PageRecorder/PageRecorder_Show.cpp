...
DEF_PAGE_3( pageShow, // -V641 // -V1027                                                                                                           //--- ÔÓÍÊÖÈß - ĞÅÃÈÑÒĞÀÒÎĞ - ÏĞÎÑÌÎÒĞ ---
    ...
    &cCursor,
    //PageFunction::PageRecorder::PageShow::PageOperations::self,  ///< ÔÓÍÊÖÈß - ĞÅÃÈÑÒĞÀÒÎĞ - ÏĞÎÑÌÎÒĞ - ÎÏÅĞÀÖÈÈ
    //PageFunction::PageRecorder::PageShow::PageView::self,        ///< ÔÓÍÊÖÈß - ĞÅÃÈÑÒĞÀÒÎĞ - ÏĞÎÑÌÒÎĞ - ÏĞÎÑÌÎÒĞ
