...
DEF_CHOICE_2( cShow,                                                                                                                                 //--- ФУНКЦИЯ - РЕГИСТРАТОР - Всегда ---
    ...
    "В режиме",
    "Всегда",
    RECORDER_VIEW_ALLWAYS, pageRecorder, 0, 0, Choice::FuncDraw
)
...
DEF_PAGE_2( pageRecorder, // -V641 // -V1027                                                                                                                  //--- ФУНКЦИЯ - РЕГИСТРАТОР ---
    ...
    Page::Name::Function_Recorder, PageFunction::pointer, 0, OnOpenClose_Recorder, Page::FuncDraw, FuncRegSetPage
)
