...
DEF_CHOICE_2( cChanA,                                                                                                                    //--- ФУНКЦИЯ - РЕГИСТРАТОР - ИСТОЧНИК - Канал 1 ---
    ...
    DISABLE_RU,
    ENABLE_RU,
    RECORDER_SOURCE_A, pageSource, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_2( cChanB,                                                                                                                    //--- ФУНКЦИЯ - РЕГИСТРАТОР - ИСТОЧИНК - Канал 2 ---
    ...
    DISABLE_RU,
    ENABLE_RU,
    RECORDER_SOURCE_B, pageSource, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_2( cSensor,                                                                                                                    //--- ФУНКЦИЯ - РЕГИСТРАТОР - ИСТОЧИНК - Датчик ---
    ...
    DISABLE_RU,
    ENABLE_RU,
    RECORDER_SOURCE_SENSOR, pageSource, 0, 0, Choice::FuncDraw
)
...
DEF_PAGE_2( pageSource, // -V641 // -V1027                                                                                                         //--- ФУНКЦИЯ - РЕГИСТРАТОР - ИСТОЧНИК ---
    ...
    Page::Name::Function_Recorder_Source, PageFunction::PageRecorder::pointer, 0, Page::FuncPress, Page::FuncDraw, FuncRegSetPage
)
