...
DEF_CHOICE_2( cFFT_View,                                                                                                                             //--- ФУНКЦИЯ - СПЕКТР - Отображение ---
    ...
    DISABLE_RU,
    ENABLE_RU,
    FFT_ENABLED, ppFFT, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_2( cFFT_Scale,                                                                                                                                  //--- ФУНКЦИЯ - СПЕКТР - Шкала ---
    ...
    "Логарифм",
    "Линейная",
    SCALE_FFT, ppFFT, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_3( cFFT_Source,                                                                                                                              //--- ФУНКЦИЯ - СПЕКТР - Источник ---
    ...
    "Канал 2",
    "Канал 1 + 2",
    SOURCE_FFT, ppFFT, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_4( cFFT_Window,                                                                                                                                  //--- ФУНКЦИЯ - СПЕКТР - Окно ---
    ...
    "Блэкмена",
    "Ханна",
    WINDOW_FFT, ppFFT, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_3( cFFT_Range,                                                                                                                               //--- ФУНКЦИЯ - СПЕКТР - Диапазон ---
    ...
    "-60дБ",
    "-80дБ",
    MAX_DB_FFT, ppFFT, IsActive_FFT_Range, 0, Choice::FuncDraw
)
...
DEF_PAGE_1( pppFFT_Cursors, // -V641 // -V1027                                                                                                           //--- ФУНКЦИЯ - СПЕКТР - КУРСОРЫ ---
    ...
    &ppFFT,                                     ///< СЕРВИС - СПЕКТР
    IsActive_FFT_Cursors, Page::FuncPress, Page::FuncDraw, HandlerKey_FFT_Cursors
)
