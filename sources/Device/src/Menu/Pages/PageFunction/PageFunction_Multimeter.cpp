...
DEF_PAGE_5_VAR( pMultimeter, // -V641 //-V1027 //-V641
    ...
    &cZero,
    &Item::empty,
    PageName::Function_Multimeter, &PageFunction::self, Item::Active, OnOpenClose_Multimeter, Page::BeforeDraw, Page::HandlerKeyEvent
)
...
DEF_PAGE_2( pCalibration, //-V641 //-V1027
    ...
    &bCalibrate0,
    &bCalibrate1,
    PageName::Function_Multimeter_Cal, &PageMultimeter::self, Item::Active, Choice::Changed, Page::BeforeDraw, Page::HandlerKeyEvent
)
