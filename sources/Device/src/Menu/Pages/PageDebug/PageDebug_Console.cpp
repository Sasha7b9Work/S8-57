...
DEF_CHOICE_2( cSizeFont,                                                                                                                          //--- ОТЛАДКА - КОНСОЛЬ - Размер шрифта ---
    ...
    "5", "5",
    "8", "8",
    set.dbg_sizeFont, pageConsole, FuncActive, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cModeStop,                                                                                                                          //--- ОТЛАДКА - КОНСОЛЬ - Реж. останова ---
    ...
    ENABLE_RU, ENABLE_EN,
    MODE_PAUSE_CONSOLE, pageConsole, FuncActive, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_ShowAll,                                                                                                     //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Показывать все ---
    ...
    "Нет", "No",
    "Да", "Yes",
    DBG_SHOW_ALL, pageRegisters, FuncActive, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_RD_FL,                                                                                                                //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - RD_FL ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    DBG_SHOW_FLAG, pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_RShiftA,                                                                                                           //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U см. 1к ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showRShift[Chan::A], pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_RShiftB,                                                                                                           //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U см. 2к ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showRShift[Chan::B], pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_TrigLev,                                                                                                           //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U синхр. ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showTrigLev, pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_RangeA,                                                                                                         //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВОЛЬТ/ДЕЛ 1 ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showRange[Chan::A], pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_RangeB,                                                                                                         //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВОЛЬТ/ДЕЛ 2 ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showRange[Chan::B], pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_TrigParam,                                                                                                    //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. синхр. ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showTrigParam, pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_ChanParamA,                                                                                                   //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. кан. 2 ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showChanParam[Chan::A], pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_ChanParamB,                                                                                                   //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. кан. 2 ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showChanParam[Chan::B], pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_TBase,                                                                                                            //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВРЕМЯ/ДЕЛ ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showTBase, pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
...
DEF_CHOICE_2( cRegisters_TShift,                                                                                                               //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Т см. ---
    ...
    DISABLE_RU, DISABLE_EN,
    ENABLE_RU, ENABLE_EN,
    set.dbg_showTShift, pageRegisters, IsActive_Console_Registers, Choice::FuncChange, FuncDraw
)
