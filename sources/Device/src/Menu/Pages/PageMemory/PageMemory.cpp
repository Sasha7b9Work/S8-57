...
DEF_CHOICE_2( cDrive_Name,                                                                                                                            //--- ПАМЯТЬ - ВНЕШН ЗУ - Имя файла ---
    ...
    "По маске",
    "Вручную",
    FILE_NAMING_MODE, ppDrive, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_2( cDrive_SaveAs,                                                                                                                      //--- ПАМЯТЬ - ВНЕШН ЗУ - Сохранять как ---
    ...
    "Изображение",
    "Текст",
    MODE_SAVE, ppDrive, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_2( cDrive_ModeBtnMemory,                                                                                                               //--- ПАМЯТЬ - ВНЕШН ЗУ - Реж кн ПАМЯТЬ ---
    ...
    "Меню",
    "Сохранение",
    MODE_BTN_MEMORY, ppDrive, 0, 0, Choice::FuncDraw
)
...
DEF_CHOICE_2( cDrive_Autoconnect,                                                                                                               //--- ПАМЯТЬ - ВНЕШН ЗУ - Автоподключение ---
    ...
    DISABLE_RU,
    ENABLE_RU,
    FLASH_AUTOCONNECT, ppDrive, 0, 0, Choice::FuncDraw
)
