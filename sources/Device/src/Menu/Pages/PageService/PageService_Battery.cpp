...
DEF_CHOICE_2( cShow,                                                                                                                                  //--- СЕРВИС - БАТАРЕЯ - Показывать ---  
    ...
    DISABLE_RU,
    ENABLE_RU,
    BAT_SHOW_ON_DISPLAY, pageBattery, 0, Choice::FuncChange, Choice::FuncDraw
)
...
DEF_PAGE_1( pageBattery, // -V641 // -V1027                                                                                                                        //--- СЕРВИС - БАТАРЕЯ ---
    ...
    Page::Name::Service_Battery, PageService::pointer, 0, Page::FuncPress, Page::FuncDraw, FuncRegSetPage
)
