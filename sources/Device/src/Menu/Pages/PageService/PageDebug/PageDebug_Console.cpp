...
DEF_PAGE_12( pageRegisters, // -V641                                                                                                                   //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ ---
    ...
    Page::Name::Debug_Console_Registers, &pageConsole, Page::FuncActive, Page::FuncPress, Page::FuncDraw, FuncRegSetPage
)
...
//    &bSizeSettings,     ///< ОТЛАДКА - КОНСОЛЬ - Размер настроек
    Page::Name::Debug_Console, PageService::PageDebug::pointer, Page::FuncActive, Page::FuncPress, Page::FuncDraw, FuncRegSetPage
)
