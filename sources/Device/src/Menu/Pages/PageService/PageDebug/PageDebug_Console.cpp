...
DEF_PAGE_12( pRegisters, // -V641                                                                                                                      //--- ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ ---
    "РЕГИСТРЫ",
    "",
    &cShowAll,        ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Показывать все
    &cRD_FL,          ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - RD_FL
    &cRShiftA,        ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U см. 1к
    &cRShiftB,        ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U см. 2к
    &cTrigLev,        ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U синхр
    &cRangeA,         ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВОЛЬТ/ДЕЛ 1
    &cRangeB,         ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВОЛЬТ/ДЕЛ 2
    &cTrigParam,      ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. синхр.
    &cChanParamA,     ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. кан. 1
