...
DEF_PAGE_2( ppSound, // -V641 // -V1027                                                                                                                               //--- СЕРВИС - ЗВУК ---
    ...
    Page::Name::Service_Sound, &pService, 0, 0, 0, FuncRegSetPage
)
...
DEF_PAGE_2( ppRTC, // -V641 // -V1027                                                                                                                                //--- СЕРВИС - ВРЕМЯ ---
    ...
    Page::Name::Service_RTC, &pService, 0, 0, 0, FuncRegSetPage
)
...
DEF_PAGE_7( pService, // -V641 // -V1027                                                                                                                                    //--- СЕРВИС ---
    ...
    Page::Name::Service, nullptr, 0, 0, 0, FuncRegSetPage
)
