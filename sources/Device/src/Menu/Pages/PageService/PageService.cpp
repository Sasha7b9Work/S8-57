...
DEF_PAGE_2( ppSound, // -V641 // -V1027                                                                                                                               //--- СЕРВИС - ЗВУК ---
    ...
    Page::Name::Service_Sound, &pService, 0, Page::FuncPress, 0, FuncRegSetPage
)
...
DEF_PAGE_2( ppRTC, // -V641 // -V1027                                                                                                                                //--- СЕРВИС - ВРЕМЯ ---
    ...
    Page::Name::Service_RTC, &pService, 0, Page::FuncPress, 0, FuncRegSetPage
)
...
DEF_PAGE_SB( ppInformation, // -V641                                                                                                                            //--- СЕРВИС - ИНФОРМАЦИЯ ---
    ...
    0,
    0,
    Page::Name::SB_Service_Information, &pService, 0, OnPress_Information, 0, FuncRegSetPage
)
...
DEF_PAGE_7( pService, // -V641 // -V1027                                                                                                                                    //--- СЕРВИС ---
    ...
    Page::Name::Service, nullptr, 0, Page::FuncPress, 0, FuncRegSetPage
)
