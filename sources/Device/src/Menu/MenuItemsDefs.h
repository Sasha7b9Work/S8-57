...
static const HeadItem hi##name = { Item::Type::Button, 0, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::GovernorColor, 0, Page::Name::NoPage, keeper, EmptyFuncBtV, th##name };                                                                      \
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::GovernorColor, 0, Page::Name::NoPage, keeper, funcActive, th##name };                                                                        \
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::GovernorColor, 2, Page::Name::NoPage, keeper, funcActive, th##name };                                                                        \
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::GovernorColor, 3, Page::Name::NoPage, keeper, funcActive, th##name };                                                                        \
static const GraphButton name(&hi##name, h##name, funcPress, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::GovernorColor, 5, Page::Name::NoPage, keeper, funcActive, th##name };                                                                        \
static const GraphButton name(&hi##name, h##name, funcPress, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 1, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 2, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 3, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 4, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 5, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 6, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 7, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 8, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Page, 12, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 2, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 3, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 4, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 5, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 6, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 7, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 9, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 10, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const HeadItem hi##name = { Item::Type::Choice, 16, Page::Name::NoPage, keeper, funcActive, th##name };                                                                               \
static const Choice name(&hi##name, n##name, (int8 *)&cell, funcChanged, funcDraw);
