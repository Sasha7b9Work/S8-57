...
static const SButtonDef name = { Item::Type::DrawButton, 0, false, Page::Name::NoPage, keeper, funcActive,                                                                                  \
     {title, hint}, funcPress, funcDraw, 0, 0};

#define DEF_SMALL_BUTTON_EXIT(name, keeper, funcActive, funcPress, funcDraw)                                                                                                                \
static const SButtonDef name = { Item::Type::DrawButton, 0, false, Page::Name::NoPage, keeper, funcActive, {"Выход",                                                                        \
...
static const SButtonDef name = { Item::Type::DrawButton, 0, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                                                   \
