...
static const DataItem di##name = { Item::Type::Button, title, hint, 0, Page::Name::NoPage, keeper, funcActive, &db##name };                                                                 \
...
static const DataItem di##name = { Item::Type::Button, title, hint, 0, Page::Name::NoPage, keeper, funcActive, &dg##name };                                                                 \
...
static const DataItem di##name = { Item::Type::GovernorColor, title, hint, 0, Page::Name::NoPage, keeper, EmptyFuncBtV, &dgc##name };                                                       \
...
static const DataItem hi##name = { Item::Type::GovernorColor, title, hint, 0, Page::Name::NoPage, keeper, funcActive, &dgb##name };                                                         \
...
static const DataItem hi##name = { Item::Type::GovernorColor, title, hint, 2, Page::Name::NoPage, keeper, funcActive, &dgb##name };                                                         \
static const GraphButton name(&hi##name);
...
static const DataGraphButton dgb##name = {funcPress, funcDraw, h##name};                                                                                                                    \
static const DataItem hi##name = { Item::Type::GovernorColor, title, hint, 3, Page::Name::NoPage, keeper, funcActive, &dgb##name };                                                         \
static const GraphButton name(&hi##name);
...
static const DataGraphButton dgb##name = {funcPress, funcDraw, h##name};                                                                                                                    \
static const DataItem hi##name = { Item::Type::GovernorColor, title, hint, 5, Page::Name::NoPage, keeper, funcActive, &dgb##name };                                                         \
static const GraphButton name(&hi##name);
...
static const DataItem di##name = { Item::Type::Page, title, hint, 1, namePage, keeper, funcActive, &dp##name };                                                                             \
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 2, namePage, keeper, funcActive, &dp##name };                                                                             \
static const Page name(&di##name);
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 3, namePage, keeper, funcActive, &dp##name};                                                                              \
static const Page name(&di##name);
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 4, namePage, keeper, funcActive, &dp##name };                                                                             \
static const Page name(&di##name);
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 5, namePage, keeper, funcActive, &dp##name };                                                                             \
static const Page name(&di##name);
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 6, namePage, keeper, funcActive, &dp##name };                                                                             \
static const Page name(&di##name);
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 7, namePage, keeper, funcActive, &dp##name };                                                                             \
static const Page name(&di##name);
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 8, namePage, keeper, funcActive, &dp##name };                                                                             \
static const Page name(&di##name);
...
static const DataPage dp##name = {i##name, funcPress, funcDraw, funcRegSet};                                                                                                                \
static const DataItem di##name = { Item::Type::Page, title, hint, 12, namePage, keeper, funcActive, &dp##name };                                                                            \
static const Page name(&di##name);
...
static const DataItem di##name = { Item::Type::Choice, title, hint, 2, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                 \
...
static const DataChoice dc##name[] = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                       \
static const DataItem di##name = { Item::Type::Choice, title, hint, 3, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                 \
static const Choice name(&di##name);
...
static const DataChoice dc##name[] = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                       \
static const DataItem di##name = { Item::Type::Choice, title, hint, 4, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                 \
static const Choice name(&di##name);
...
static const DataChoice dc##name[] = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                       \
static const DataItem di##name = { Item::Type::Choice, title, hint, 5, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                 \
static const Choice name(&di##name);
...
static const DataChoice dc##name[] = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                       \
static const DataItem di##name = { Item::Type::Choice, title, hint, 6, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                 \
static const Choice name(&di##name);
...
static const DataChoice dc##name[] = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                       \
static const DataItem di##name = { Item::Type::Choice, title, hint, 7, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                 \
static const Choice name(&di##name);
...
static const DataChoice dc##name = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                         \
static const DataItem di##name = { Item::Type::Choice, title, hint, 9, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                 \
static const Choice name(&di##name);
...
static const DataChoice dc##name = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                         \
static const DataItem di##name = { Item::Type::Choice, title, hint, 10, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                \
static const Choice name(&di##name);
...
static const DataChoice dc##name = {(int8 *)&cell, n##name, funcChanged, funcDraw};                                                                                                         \
static const DataItem di##name = { Item::Type::Choice, title, hint, 16, Page::Name::NoPage, keeper, funcActive, &dc##name };                                                                \
static const Choice name(&di##name);
