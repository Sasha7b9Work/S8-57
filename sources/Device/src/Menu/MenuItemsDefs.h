...
#define DEF_PAGE_6(name, titleRU, titleEN, hintRU, hintEN,                                                                                              \
    item1, item2, item3, item4, item5, item6, namePage, keeper, funcActive, funcPress, funcDraw, funcRegSet)                                            \
...
#define DEF_PAGE_8(name, titleRU, titleEN, hintRU, hintEN,                                                                                              \
    item1, item2, item3, item4, item5, item6, item7, item8, namePage, keeper, funcActive, funcPress, funcDraw, funcRegSet)                              \
static const Control * const  items##name[] = {(Control *)item1, (Control *)item2, (Control *)item3, (Control *)item4, (Control *)item5,                \
...
volatile static const SButtonBase name = { Control::Type::DrawButton, 0, false, Page::Name::NoPage, &keeper, funcActive,                                \
     {titleRU, titleEN, hintRU, hintEN}, funcPress, funcDraw, 0, 0};
...
volatile static const SButtonBase name = { Control::Type::DrawButton, 0, false, Page::Name::NoPage, &keeper, funcActive,                                \
     {titleRU, titleEN, hintRU, hintEN}, funcPress, funcDraw, hints##name, 2};
...
static const pString hints##name[] = {nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3};                                                            \
...
static const pString hints##name[] = {nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3, nameRu4, nameEn4};                                          \
...
static pString hints##name[] = {nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3, nameRu4, nameEn4,                                                 \
    nameRu5, nameEn5};                                                                                                                                  \
volatile static const ChoiceBase name = {Control::Type::Choice, 5, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},  \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::Choice, 6, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},           \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::Choice, 7, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},           \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::Choice, 8, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},           \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::Choice, 9, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},           \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};

#define DEF_CHOICE_10(name, titleRU, titleEN, hintRU, hintEN,                                                                                           \
    nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3, nameRu4, nameEn4, nameRu5, nameEn5,                                                           \
...
static const ChoiceBase name = {Control::Type::Choice, 10, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},          \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
#define DEF_CHOICE_16(name, titleRU, titleEN, hintRU, hintEN,                                                                                           \
    ...
    nameRu9, nameEn9, nameRu10, nameEn10, nameRu11, nameEn11, nameRu12, nameEn12, nameRu13, nameEn13, nameRu14, nameEn14, nameRu15, nameEn15,           \
    nameRu16, nameEn16, cell, keeper, funcActive, funcChanged, funcDraw)                                                                                \
static pString hints##name[] = {nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3, nameRu4, nameEn4, nameRu5, nameEn5, nameRu6, nameEn6,             \
    nameRu7, nameEn7, nameRu8, nameEn8, nameRu9, nameEn9, nameRu10, nameEn10, nameRu11, nameEn11, nameRu12, nameEn12, nameRu13, nameEn13,               \
    nameRu14, nameEn14, nameRu15, nameEn15, nameRu16, nameEn16 };                                                                                       \
volatile static const ChoiceBase name = {Control::Type::Choice, 16, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
