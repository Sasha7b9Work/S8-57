...
static const ButtonDef name = { Control::Type::Button, 0, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                     \
    funcPress, funcDraw };
...
static const GovernorDef name = {Control::Type::Governor, 0, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                  \
...
static const GovernorColorDef name = {Control::Type::GovernorColor, 0, false, Page::Name::NoPage, keeper, 0,                                                \
...
static const Control * const  items##name[] = {(Control *)item0, (Control *)item1, (Control *)item2, (Control *)item3, (Control *)item4,                    \
    (Control *)item5};                                                                                                                                      \
static const PageDef name = {Control::Type::Page, 6, true, namePage, keeper, funcActive, {title, hint}, items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 1, false, namePage, keeper, funcActive, {title, hint},                                                    \
...
static const PageDef name = {Control::Type::Page, 2, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 3, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 4, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 5, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 6, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 7, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 8, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 9, false, namePage, keeper, funcActive, {title, hint},                                                    \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 10, false, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                              \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 11, false, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                              \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 12, false, namePage, keeper, funcActive, {title, hint},                                                   \
    items##name, funcPress, funcDraw, funcRegSet};
...
static const PageDef name = {Control::Type::Page, 13, false, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                              \
...
static const PageDef name = {Control::Type::Page, 15, false, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                              \
    items##name, funcPress, FuncDrawPage, 0};
...
static const SButtonDef name = { Control::Type::DrawButton, 0, false, Page::Name::NoPage, keeper, funcActive,                                               \
     {title, hint}, funcPress, funcDraw, 0, 0};

#define DEF_SMALL_BUTTON_EXIT(name, keeper, funcActive, funcPress, funcDraw)                                                                                \
static const SButtonDef name = { Control::Type::DrawButton, 0, false, Page::Name::NoPage, keeper, funcActive, {"Выход",                                     \
...
static const SButtonDef name = { Control::Type::DrawButton, 0, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                \
...
static const ChoiceDef name = {Control::Type::Choice, 2, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
...
static const ChoiceDef name = {Control::Type::Choice, 3, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 4, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 5, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 6, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 7, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 8, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 9, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                      \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 10, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                     \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::Choice, 16, false, Page::Name::NoPage, keeper, funcActive, {title, hint},                                     \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::ChoiceReg, 9, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},             \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
...
static const ChoiceDef name = {Control::Type::ChoiceReg, 10, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},            \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
