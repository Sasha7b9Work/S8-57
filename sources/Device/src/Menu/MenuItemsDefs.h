...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 1, namePage, keeper, funcActive, th##name };                                                                                           \
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 2, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 3, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 4, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 5, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 6, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 7, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 8, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
...
static const pString th##name[] = {title, hint};                                                                                                                                            \
static const DataItem hi##name = { Item::Type::Page, 12, namePage, keeper, funcActive, th##name };                                                                                           \
static const Page name(&hi##name, i##name, funcPress, funcDraw, funcRegSet);
