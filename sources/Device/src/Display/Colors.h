...
public:
    ...
    static Color MenuItemField(bool shade);     ///< Цвет пункта меню с выбранным значением.
    static Color MenuTitleText(bool shade);     ///< Цвет заголовка страницы или элемента меню.
