...
/*! \page page1 Межпроцессорные коммуникации
    ...
    |    |       | 127 PG12 CS  | I  | READY | 7  PC13     | O  | "1" означает установку флага
    |    |       | 119 PD5  WR  | IO | FL0   | 86 PD5  WR  | IO | "1" означает установку флага
    |    |       | 118 PD4  RD  | IO | CS    | 85 PD4  RD  | IO |
    |    |       |              |    |       |             |    |
    |    |       |              |    |       |             |    |          Замены пинов
    |    |       |              |    |       |             |    |  +-------------+--------------+
    |    |       |              |    |       |             |    |  | Устройство  |    Панель    |
    |    |       |              |    |       |             |    |  +-------------+--------------+
    |    |       | 43  PA7      | IO | FL0   | 8  PC14     | O  |  | PD5  -> PA7 | PD5  -> PC14 |
    |    |       | 44  PC4      | I  | READY | 9  PC15     | O  |  | PG12 -> PC4 | PC13 -> PC15 |
    |    |       | 127 PG12 CS  | O  | CS    | 7  PC13     | I  |  |             |              |
    |    |       | 119 PD5  WR  | O  | MODE0 | 86 PD5  WR  | I  |  | PA7  -> PD5 | PC14 -> PD5  |
    |    |       | 118 PD4  RD  | O  | MODE1 | 85 PD4  RD  | I  |  | PC4  -> PD4 | PC15 -> PD4  |
    |    |       |              |    |       |             |    |  +-------------+--------------+
