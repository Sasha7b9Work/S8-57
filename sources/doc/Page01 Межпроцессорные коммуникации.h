...
/*! \page page1 Межпроцессорные коммуникации
    ...
    |    | AD5   | 59  PE8  D5  | I  | CONFIRM    | 4  PE5      | O  | Подтверждение панелью завершения транзакции. ЦП даёт обратное подтверждением переводом CS в высокое состояние
    |    | AD6   | 60  PE9  D6  |    |            | 5  PE6      |    |
    |    | AD7   | 63  PE10 D7  |    |            | 38 PE7      |    |
    +----+-------+--------------+----+------------+-------------+----+
