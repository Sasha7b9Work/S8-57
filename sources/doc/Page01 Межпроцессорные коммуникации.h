...
/*! \page page1 Межпроцессорные коммуникации
    ...
    |    | AD5   | 59  PE8  D5  | I  | CONF_PANEL | 4  PE5      | O  | Подтверждение панелью завершения транзакции. ЦП даёт обратное подтверждением переводом CS в высокое состояние
    |    | AD6   | 60  PE9  D6  | O  | NIBBLE     | 5  PE6      | I  | 0 - младший полубайт, 1 - старший полубайт
    |    | AD7   | 63  PE10 D7  | O  | CONF_CPU   | 38 PE7      | I  |
    +----+-------+--------------+----+------------+-------------+----+
