...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Timer7XX::Init(TIM_TypeDef *instance, uint prescaler, uint counterMode, uint period, uint clcDiv)
{
    if (instance == TIM2)
    {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
void Timer7XX::EnabledIRQ(uint mainPriority, uint subPriority)
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
IRQn_Type Timer7XX::GetIRQn_Type()
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
void Timer7XX::StartIT(uint period)
{
    handler.Init.Period = period;
    HAL_TIM_Base_Init(&handler);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
void Timer7XX::StopIT()
{
    HAL_TIM_Base_Stop_IT(&handler);
}

//----------------------------------------------------------------------------------------------------------------------------------------------------
void Timer7XX::DeInit()
{
